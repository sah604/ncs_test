...
public interface InterProduct extends java.io.Serializable, java.util.Comparator {
	...
	/* 상수필드만 가질수 있기 때문에 모든 필드는 묵시적으로 public static final이다.  아래처럼 묵시적으로 생략가능해서 작성가능. */ 
	int MIN_NUM = 10;
	
	/* 인터 페이스는 생성자를 가질 수 없다. */
//	public InterProduct() {}
	
	/* 인터페이스는 구현부(body)가 있는 non-static 메소드를 가질수 없다.*/
//	public void nonStaticMethod() {}
	...
	/* 또한 default 키워드를 사용하면  non-static 메소드도 작성가능하다. (JDK 1.8에 추가된 기능 ) */
